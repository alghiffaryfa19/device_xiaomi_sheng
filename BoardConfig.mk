...
BOARD_KERNEL_CMDLINE := video=vfb:640x400,bpp=32,memsize=3072000 disable_dma32=on swinfo.fingerprint=sheng:13/V816.0.5.0.UNXMIXM:user mtdoops.fingerprint=sheng:13/V816.0.5.0.UNXMIXM:user
...
BOARD_XIAOMI_DYNAMIC_PARTITIONS_SIZE := 11806965760 # (BOARD_SUPER_PARTITION_SIZE - 4 MiB)
